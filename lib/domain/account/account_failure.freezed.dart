...
class _$_WrongPassword implements _WrongPassword {
  ...
  @override
  String toString() {
    return 'AccountFailure.wrongPassword()';
  }
...
abstract class _WrongPassword implements AccountFailure {
...
class _$_UsernameTaken implements _UsernameTaken {
  ...
  @override
  String toString() {
    return 'AccountFailure.usernameTaken()';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is _UsernameTaken);
  }
...
abstract class _UsernameTaken implements AccountFailure {
