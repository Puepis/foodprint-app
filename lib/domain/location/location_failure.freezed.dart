...
mixin _$LocationFailure {
  ...
  Result when<Result extends Object>({
    ...
    @required Result locationServiceDisabled(),
    @required Result unexpected(),
  });
  @optionalTypeArgs
  Result maybeWhen<Result extends Object>({
    Result permissionDenied(),
    Result locationServiceDisabled(),
    Result unexpected(),
  ...
  Result map<Result extends Object>({
    ...
    @required Result locationServiceDisabled(_LocationServiceDisabled value),
    @required Result unexpected(_Unexpected value),
  });
  @optionalTypeArgs
  Result maybeMap<Result extends Object>({
    Result permissionDenied(_PermissionDenied value),
    Result locationServiceDisabled(_LocationServiceDisabled value),
...
class _$_LocationServiceDisabled implements _LocationServiceDisabled {
  ...
  @override
  String toString() {
    return 'LocationFailure.locationServiceDisabled()';
  }
...
abstract class _LocationServiceDisabled implements LocationFailure {
