...
abstract class PhotoActionsState with _$PhotoActionsState {
  ...
  const factory PhotoActionsState.deleteSuccess(FoodprintEntity foodprint) = DeleteSuccess;
  const factory PhotoActionsState.editFailure(PhotoFailure failure) = EditFailure;
  const factory PhotoActionsState.editSuccess(FoodprintEntity foodprint) = EditSuccess;
  const factory PhotoActionsState.saveFailure(PhotoFailure failure) = SaveFailure;
  const factory PhotoActionsState.saveSuccess(FoodprintEntity foodprint) = SaveSuccess;
}